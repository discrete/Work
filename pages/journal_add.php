<?php 
function journal_add( $p_bug_id, $f_manday, $f_worktype_id = 0, $p_user_id = null, $p_send_email = TRUE ) {
	$c_bug_id = db_prepare_int( $p_bug_id );
	$c_worktype_id = db_prepare_int( $f_worktype_id );
	
	$t_manday = db_prepare_int($f_manday);
...
<?php
	...
	$t_bugnote_id = journal_add( $f_bug_id, $f_worktype_id, $f_manday,  BUGNOTE );
    if ( !$t_bugnote_id ) {
